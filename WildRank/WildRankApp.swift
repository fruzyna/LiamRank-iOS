...
struct WildRankApp: App {
    ...
    func determineRelease(fileURL: URL) -> String {
        do {
            ...
            let releaseSearchKey = "/WildStang/WildRank/releases/tag/"
    ...
    func isReleaseCached(release: String) -> Bool {
        ...
        let path = docURL.appendingPathComponent("WildRank-\(release)").relativePath
    ...
    func start(release: String) {
        if release == "latest" {
            let latestURL = URL(string: "https://github.com/WildStang/WildRank/releases/latest")!
    ...
    func fetchRelease(release: String) {
        ...
        let remoteURL = URL(string: "https://github.com/WildStang/WildRank/archive/\(release).zip")!
    ...
    func processArchive(urlOrNil: URL?, responseOrNil: URLResponse?, errorOrNil: Error?) {
        ...
        if fileURL != nil {
            ...
            do {
                try fileManager.removeItem(at: docURL.appendingPathComponent("WildRank-\(release)"))
    ...
    func startRelease(release: String) {
        ...
        buildServer(repoURL: docURL.appendingPathComponent("WildRank-\(release)"))
    ...
    func buildServer(repoURL: URL) {
            ...
            // about page
                ...
                let contents = """
                    ...
                    <html lang="en">\
                        ...
                        <body>\
                            <h1>WildRank</h1>\
                            WildRankApp.swift Swift POST server<br>2021 WildStang Robotics<br><a href="https://github.com/WildStang/WildRank-iOS-Server">MPL Licensed on GitHub</a>\
                        </body>\
                    </html>
                    """
        ...
        // TODO: configure port
        DispatchQueue.main.async() {
            server.start(withPort: 8080, bonjourName: "WildRank iOS")
        }
    }
}
